...
@section('content')
    <div class="bg-[#f9fdf5] py-12 md:py-16 px-4">
        <div class="container mx-auto max-w-5xl">
            ...
            {{-- TENTANG DESA (statis) --}}
            <section
                class="bg-[#D4F36B] p-6 md:p-8 rounded-2xl mb-8 shadow-md hover:shadow-xl  transition-all duration-300">
                <h2
            ...
            <section
                class="bg-[#D4F36B] p-6 md:p-8 rounded-2xl mb-10 shadow-md hover:shadow-xl  transition-all duration-300">
            ...
            <section id="struktur"
                ...
                <div class="bg-white hover:shadow-xl hover:-translate-y-1 p-5 rounded-xl shadow-inner border border-gray-200 transition-all duration-300">
            ...
            <section
                class="bg-[#D4F36B] p-6 md:p-8 rounded-2xl shadow-md hover:shadow-xl  transition-all duration-300">
                <h2
                    class="font-poppins text-xl font-bold uppercase text-gray-900 mb-6 border-b-2 border-gray-900 inline-block pb-1">
                    Visi dan Misi
                </h2>
